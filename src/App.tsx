...
function AppContent() {
  ...
  // Caricamento ID stanza dal localStorage all'avvio
  useEffect(() => {
    const saved = localStorage.getItem('lastActiveRoomId');
  ...
  if (loading) return <div className="h-screen flex items-center justify-center bg-gray-950"><Loader2 className="animate-spin text-violet-500" /></div>;
