  ...
  public: {
    Tables: {
      profiles: {
        ...
        Insert: { id: string; email: string; display_name: string; encrypted_api_key?: string | null; ai_provider?: string; mcp_endpoint?: string | null; has_completed_setup?: boolean; }
