  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="bg-gray-900 border-gray-800 text-white max-w-2xl">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white font-medium">Next.js + Tailwind CSS</span>
                </div>
                <div className="flex justify-between text-sm">
        ...
        {step === 'progress' && (
          <div className="space-y-4">
            <ScrollArea className="h-[400px] bg-gray-950 rounded-lg border border-gray-800 p-4">
              <div className="space-y-2 font-mono text-sm">
                {logs.map((log, index) => (
                  <div key={index} className="flex items-start gap-2">
                    {log.type === 'info' && (
                      <Loader2 className="h-4 w-4 text-blue-400 animate-spin flex-shrink-0 mt-0.5" />
                    )}
                    {log.type === 'success' && (
          ...
          <div className="space-y-4">
            <div className="text-center space-y-4 py-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400">
                  Your project "{projectName}" has been successfully created and deployed.
                  Check your email for access credentials and the project URL.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 space-y-2">
              ...
              <ul className="text-sm text-gray-300 space-y-1 list-disc list-inside">
                <li>Access your project via the link sent to your email</li>
                <li>Review the generated codebase</li>
                <li>Customize and deploy to production</li>
                <li>Share with your team for collaboration</li>
              </ul>
            </div>

            <Button onClick={handleClose} className="w-full bg-green-600 hover:bg-green-500 text-white">
              Close
            </Button>
          </div>
        )}
